...
RefreshTokenGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    ...
    .then(function(token) {
      return this.saveToken(token.user, client, token.scope, token.passport);
    });
};
...
RefreshTokenGrantType.prototype.saveToken = function(user, client, scope, passport) {
  var fns = [
  ...
  return Promise.all(fns)
    .bind(this)
    .spread(function(accessToken, refreshToken, accessTokenExpiresAt, refreshTokenExpiresAt, passport) {
      var token = {
