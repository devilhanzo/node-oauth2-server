...
AuthenticateHandler.prototype.validateScope = function(accessToken) {
  return promisify(this.model.validateScope, 2).call(this.model, accessToken, this.scope)
    .then(function(scope) {
      if (!scope) {
        throw new InvalidScopeError('Invalid scope: authorized scope is invalid');
      }
